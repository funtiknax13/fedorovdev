(function () {
  ...
  const T = {
    ru: {
      ...
      "p6.p": "Портал бегового сообщества: роли участников, организация событий и пробежек, запись на забеги и поддержка.",
    ...
    en: {
      ...
      "p6.p": "Running community portal: member roles, event and run organisation, sign-ups and support.",
      "p6.link": "Open site →",
