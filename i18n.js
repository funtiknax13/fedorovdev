(function () {
  ...
  const T = {
    ru: {
      ...
      "p6.tag": "Продакшн · Сообщество · FastAPI / React",
      "p6.p": "Портал бегового сообщества: роли участников, организация событий и пробежек, запись на забеги, протоколы и рейтинги.",
      "p6.link": "Открыть сайт →",
    ...
    en: {
      ...
      "p1.link": "Open site →",
      "p6.tag": "Production · Community · FastAPI / React",
      "p6.p": "Running community portal: member roles, event and run organisation, sign-ups, results and rankings.",
      "p6.link": "Open site →",
